...
<div id="contactform"  class="contact">
	<form action="send.php" method="post" >
    	...
    	<!-- YOUR EMAIL ADDRESS -->
    	<input name="repemail" id="repemail" type="hidden" value="rafael.velez.c@gmail.com" />
    	<!-- ENTER YOUR URL BELOW: MUST CONTAIN #contact AT THE END OF THE URL-->
    	<input name="pagelink" id="pagelink" type="hidden" value="http://rafaelvelez.us/formal#contact" />
